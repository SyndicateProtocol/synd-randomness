export const RandomnessSequencerAbi = [
  {
    "type": "constructor",
    "inputs": [
      {
      ...
      {
        "name": "functionSelectorAdminRole_",
        "type": "address",
        "internalType": "address"
      },
      {
  ...
  {
    "type": "function",
    "name": "FUNCTION_SELECTOR_ADMIN_ROLE",
    "inputs": [],
    "outputs": [
      {
        "name": "",
    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple[]",
        "internalType": "struct RandomnessSequencer.ContractFunction[]",
        "components": [
          {
            "name": "contractAddress",
            "type": "address",
  ...
  {
    "type": "function",
    "name": "randomnessRequiredFunctions",
    "inputs": [
      {
        "name": "",
        "type": "uint256",
